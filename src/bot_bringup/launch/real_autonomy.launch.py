...
def generate_launch_description():
    ...
    sensors_share = get_package_share_directory("bot_sensors")
    localization_share = get_package_share_directory("bot_localization")
    planning_share = get_package_share_directory("bot_planning")
