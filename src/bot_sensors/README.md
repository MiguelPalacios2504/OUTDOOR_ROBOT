...
Publishes sensor topics expected by `bot_localization`:
...
```bash
# Mock sensors (bench)
ros2 launch bot_sensors sensors.launch.py

# Real hardware — launch your drivers, then:
ros2 launch bot_sensors sensors.launch.py use_mock_sensors:=false
```
