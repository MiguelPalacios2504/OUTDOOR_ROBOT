...
def generate_launch_description():
    ...
    xacro_path = package_share / "urdf" / "bot_v1.urdf.xacro"
    ...
    bot_description = xacro.process_file(
        str(xacro_path),
        mappings={"mesh_dir": "package://bot_description/meshes"},
    ).toxml()
    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                parameters=[{"robot_description": bot_description}],
            ),
            Node(
                package="rviz2",
                executable="rviz2",
