...
3D LiDAR: **Unitree 4D-LiDAR L2** parameters from `bot_description/config/unitree_4d_lidar_l2.yaml` (manufacturer datasheet). Publishes `sensor_msgs/PointCloud2` on `/lidar/points` at 5.55 Hz (**591×39** grid, ~128k pts/s).
